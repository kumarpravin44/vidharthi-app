...
const BASE_URL ='https://ecommerce.pdfkitpro.com';
/**
 ...
 */
export const getImageWithFallback = (imageUrl, baseUrl = BASE_URL) => {
 ...
 */
export const getAvatarUrl = (avatarUrl, baseUrl = BASE_URL) => {
